...
/**
 * shash_table_create - this reates sorted hash table.
 * @size: size of new sorted hash table.
 *
 * Return: an error occurs - NULL.
 *        oOtherwise - a pointer to the new sorted hash table.
 */
shash_table_t *shash_table_create(unsigned long int size)
{
	shash_table_t *ht;
...
/**
 * shash_table_get - this retrieve value associated with
